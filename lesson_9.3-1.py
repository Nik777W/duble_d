my_list = ['Timur', -16.648911695768902, 'six', -202, 883.0093275936454, -765, (3, 4), -105.10718000213546, 976,
...
print(*map(int, filter(lambda x: isinstance(x, (float, int)), my_list)), sep='\n')
