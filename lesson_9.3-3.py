...
# имена, которые начинаются на буквы А и М (независимо от регистра) и имеют длину больше 4.
...
print(*sorted(filter(lambda x: x[0] in ['А','М'] and len(x) > 4, (map(str.title , names)))), sep=' ')