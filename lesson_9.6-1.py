...
# Функция должна возвращать словарь, ключом в котором является номер строки матрицы, а значением — список
# элементов этой строки.
#
# Примечание 1. Используйте встроенные типы (list, tuple, ...), а не типы из модуля typing. Также используйте
# нотацию |, а не тип Union из модуля typing.
#
...
def matrix_to_dict(matrix: list[list[int | float]]) ->dict[int, list[int | float]]:
    ...
    return {n:i for n,i in enumerate(matrix, 1)}


# ТЕСТ    ответ {1: [5, 6, 7], 2: [8, 3, 2], 3: [4, 9, 8]}
